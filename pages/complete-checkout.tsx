            ...
            <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
                <div className="container-fluid">
                    ...
                    <div className="button-group d-flex flex-column mx-auto">
                        ...
                        <a href='https://wa.me/6281234567890?text=Saya%20sudah%20melakukan%20transfer.' className="btn btn-whatsapp fw-medium text-lg color-palette-1 rounded-pill" role="button">WhatsApp ke Admin</a>
                    </div>
                </div>
            </section>
        </>
